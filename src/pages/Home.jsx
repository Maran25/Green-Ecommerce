...
const Home = () => {
  ...
  return (
    <>
      ...
      >
        <img src={b1} alt="banner 1" className="cursor-pointer object-cover" onClick={() => navigate('/collection/women')}/>
        <img src={b2} alt="banner 2" className="cursor-pointer object-cover" onClick={() => navigate('/collection/women')}/>
        <img src={b3} alt="banner 3" className="cursor-pointer object-cover" onClick={() => navigate('/collection/men')}/>
        <img src={b4} alt="banner 4" className="cursor-pointer object-cover" onClick={() => navigate('/collection/shoe')}/>
      </Carousel>
    <div className="w-11/12 mx-auto">
      ...
      <div className="grid w-11/12 grid-cols-3 mx-auto min-w-full">
        ...
        <div className="flex flex-col">
          <div className="relative" onClick={() => navigate('/collection/women')}>
          ...
          <div className="relative" onClick={() => navigate('/collection/watch')}>
        ...
        <div className="relative" onClick={() => navigate('/collection/shoe')}>
      ...
      <div className="flex justify-between items-center mt-10 mb-4 sm:mt-15 md:mt-15 md:mb-8 lg:mt-20 lg:mb-10">
        <p className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold">Products</p>
        <p className="font-semibold text-xs md:text-md hover:bg-slate-50 py-1 px-2 md:py-2 md:px-4 border-[1px] rounded-full cursor-pointer" onClick={() => navigate("/all")}>View All</p>
      </div>
      {isLoading !== "loading" ? (
